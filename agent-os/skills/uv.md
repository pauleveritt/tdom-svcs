...
**Note:** If you're in Claude Code and the Astral plugin is installed, use the `/uv` skill from that plugin instead - it has more comprehensive and up-to-date guidance.
