...
| Example | Description |
|---------|-------------|
| [Basic](basic) | Chain execution, priority ordering, halting |
...
**Service Integration:** Middleware can depend on services via factory functions and `register_middleware_service()`.
