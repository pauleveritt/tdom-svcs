...
**If any files exist**, use `ask_followup_question`:
...
After they respond, use `ask_followup_question`:
...
**If the tech-stack standard exists**, read it and use `ask_followup_question`:
...
**If no tech-stack standard exists** (or they chose option 2 above), use `ask_followup_question`:
